                        ...
                        {({ isSubmitting }) => (
                            <Form className='mt-5 flex flex-col gap-3 w-3/5 max-sm:w-full max-2xl:w-full'>
                                ...
                                <div className='flex flex-col gap-1'>
                                    ...
                                    <Field type="text" name="full_name" autoComplete="off" className="bg-slate-200 p-3 rounded-md" placeholder="your names" />
                                ...
                                <div className='flex flex-col gap-1'>
                                    ...
                                    <Field type="text" name="phone_number" autoComplete="off" className="bg-slate-200 p-3 rounded-md" placeholder="+998123456789" />
                                ...
                                <div className='flex flex-col gap-1'>
                                    ...
                                    <Field type="password" name="confirm_password" autoComplete="current-password" className="bg-slate-200 p-3 rounded-md" placeholder="confirm password" />
